...
namespace SDS
{
    ...
    struct SerialElementIndex
    {
        ...
        SerialElementIndex(const uint32_t memberID, const size_t buffSize = 200);                 
